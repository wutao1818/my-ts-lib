...
export default class MyArea extends Vue{
  ...
  @Prop(String) baseUrl: string = 'http://xxx.com';
  @Prop(Number) rank: number = 4;
  ...
  public isShowProvince: boolean = true;
  public isShowCity: boolean =  false;
  public isShowCounty: boolean =  false;
  public isShowTown: boolean =  false;
  ...
  getProvinceData(): void {
    // getProvinceList().then((res: any) => {
      ...
      //   this.areaList.provinceList.map((a: any) => {
  ...
  // public getCityData(provinceId: number): void {
  //   getCityList({
  //     provinceId: provinceId
  //   }).then((res: any) => {
  //     if (res.code === '000000') {
  //       this.areaList.cityList = res.data.cityList;
  //       this.areaList.cityList.map((a: any) => {
  ...
  // public getCountyData(cityId: number): void {
  //   getCountyList({
  //     cityId: cityId,
  //   }).then((res: any) => {
  //     if (res.code === '000000') {
  //       this.areaList.countyList = res.data.countyList;
  //       this.areaList.countyList.map((a: any) => {
  ...
  // public getTownData(countyId: number): void {
  //   getTownList({
  //     countyId: countyId,
  //   }).then((res: any) => {
  //     if (res.code === '000000') {
  //       this.areaList.townList = res.data.townList;
  //       this.areaList.townList.map((a: any) => {
  ...
  // public provinceSelect(item: any, idx: number): void {
  ...
  //   }
  //   // 当前选中的样式
  //   this.areaList.provinceList.map((a: any) => a.selected = false);
  //   this.areaList.provinceList[idx].selected = true;
  // }

  // public citySelect(item: any, idx: number): void {
  ...
  //   }
  //   // 当前选中的样式
  //   this.areaList.cityList.map((a: any) => a.selected = false);
  //   this.areaList.cityList[idx].selected = true;
  // }

  // public countySelect(item: any, idx: number): void {
  ...
  //   }
  //   // 当前选中的样式
  //   this.areaList.countyList.map((a: any) => a.selected = false);
  //   this.areaList.countyList[idx].selected = true;
  // }

  // public townSelect(item: any, idx: number): void {
  ...
  //   // 当前选中的样式
  //   this.areaList.townList.map((a: any) => a.selected = false);
  //   this.areaList.townList[idx].selected = true;
  //   this.isDisabled = false;
  // }

  // public tabAddressClick(tab: number): void {
  //   if (tab === 1) {
